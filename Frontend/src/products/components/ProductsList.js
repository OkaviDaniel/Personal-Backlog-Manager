...
const ProductsList = (props) => {
  ...
  return (
    <ul className="product-list">
      {props.activeStatus === 'completed' && props.items.map((product) => (
        <ProductItem
          key={product.id}
          id={product.id}
          image={product.image}
      ...
      {props.activeStatus === 'current' && props.items.map((product) => (
        <ProductItemCurrent
          key={product.id}
          id={product.id}
          image={product.image}
      ...
      {props.activeStatus === 'backlog' && props.items.map((product) => (
        <ProductItemBacklog
          key={product.id}
          id={product.id}
          image={product.image}
      ...
      {props.activeStatus === 'dropped' && props.items.map((product) => (
        <ProductItemDropped
          key={product.id}
          id={product.id}
          image={product.image}
